    ...
    return (
        <div className="bg-gray-50 min-h-screen flex flex-col">
            <main className="flex-grow container mx-auto p-6">
                ...
                <div className="bg-blue-600 text-white px-5 py-3 rounded mb-5 w-max select-none">
                ...
                <section className="bg-white rounded shadow-sm p-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-between mb-8 gap-8 text-sm md:text-base text-gray-700">
                        ...
                        <div className="md:w-1/2 space-y-1">
                            ...
                            <div><span className="font-semibold">Mã đơn hàng: {order._id}</span></div>
                    ...
                    <div className="mt-6 border-t border-gray-200 pt-4 max-w-md">
                        <div className="flex justify-between py-1 border-b border-gray-200">
                            <div className="font-semibold">Thành tiền:</div>
                            <div className="text-right">
                                {order.items.reduce((sum, i) => sum + i.price * i.quantity, 0).toLocaleString()} VND
                            </div>
                        </div>
                        <div className="flex justify-between py-1 border-b border-gray-200">
                            <div className="font-semibold">Vận chuyển</div>
                            <div className="text-right">{SHIPPING_FEE.toLocaleString()} VND</div>
                        </div>
